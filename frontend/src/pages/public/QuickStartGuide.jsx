// frontend/src/pages/public/QuickStartGuide.jsx
      ...
      <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-lg border border-[#52796F]/10 bg-white">
                ...
                <p className="text-sm text-[#52796F] mt-2">
                  Update <span className="font-semibold text-[#1B4332]">Company Name</span>. That name will
                  appear in the Dashboard welcome banner.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg border border-[#52796F]/10 bg-white">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <Link to="/intake" className="shrink-0">
                    <Button
                      type="button"
                      variant="outline"
                      size="sm"
                ...
                <p className="text-sm text-[#52796F] mt-2">
                  Fill the minimum fields and submit. You’ll see audit counts, risk distribution, and recent audits
                  populate.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg border border-[#52796F]/10 bg-white">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <Link to="/health" className="shrink-0">
                    <Button
                      type="button"
                      size="sm"
              ...
              <div className="p-4 rounded-lg border border-[#52796F]/10 bg-white">
                <div className="flex items-center justify-between gap-3">
                  <p className="font-semibold text-[#1B4332] min-w-0 truncate">
                    Step 4: Return to Dashboard
                  </p>

                  <Link to="/dashboard" className="shrink-0">
                    <Button type="button" className="bg-[#1B4332] text-[#F8F5F0] hover:bg-[#52796F]">
        ...
        <Card className="border-[#52796F]/10">
          <CardHeader>
            ...
            <CardDescription className="text-[#52796F]">Read the flow end-to-end.</CardDescription>
          </CardHeader>
          <CardContent>
            <Link to="/HowItWorks">
              <Button
