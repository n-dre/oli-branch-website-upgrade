...
// ✅ FIXED IMPORTS (no /frontend/src in paths)
...
export default function BankLinking() {
  ...
  return (
    <DashboardLayout
      ...
      subtitle="Connect your bank to analyze fees and detect mismatches"
    >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground">
                        Upgrade to Oli Lite for $9.99
                      </h3>
                      <p className="text-sm text-muted-foreground">
                        Bank linking and fee analysis requires Oli Lite
                      </p>
                    </div>
                  </div>
                  <Button onClick={() => navigate("/pricing")} className="gap-2 credit-card-gradient">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="p-4 rounded-lg bg-card border border-border">
                    ...
                    <p className="text-2xl font-bold text-success">
                      ${feeAnalysis.savingsPotential.toFixed(2)}/mo
                    </p>
                  </div>
                </div>
                <Button className="mt-4 w-full" variant="outline" onClick={() => navigate("/fee-analysis")}>
          ...
          <CardContent className="py-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  We use 256-bit encryption and never store your login credentials. Your data is
                  read-only - we can only view transactions, never move money.
                </p>
                ...
                <div className="mt-3 flex items-center gap-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    We accept all major credit cards for payments. Your payment information is
            ...
            <div className="p-6">
              ...
              {linkingStep === "success" && (
                <div className="py-12 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Analyzing your transactions for fee mismatches...
                  </p>
                </div>
              )}
            </div>
              ...
              <div className="p-6 border-t flex justify-end gap-3">
                {linkingStep === "credentials" && (
                  <>
                    ...
                    <Button onClick={handleLink}>Connect Account</Button>
                  </>
                )}
              </div>
            )}
