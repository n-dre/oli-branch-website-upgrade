...
import {
  ...
  ChevronRight, Zap, Clock, PieChart as PieChartIcon, Search
} from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-[hsl(var(--border))] rounded-lg text-sm bg-[hsl(var(--background))] text-[hsl(var(--foreground))] focus:outline-none focus:ring-1 focus:ring-[hsl(var(--primary))] focus:border-[hsl(var(--primary))] w-48 transition-colors"
              />
            </div>
            <div className="flex items-center gap-2 border-l pl-3 border-[hsl(var(--border))]">
              <button
                onClick={handleRefresh}
                disabled={isRefreshing}
                className="p-2 text-muted-foreground hover:text-[hsl(var(--primary))] hover:bg-[hsl(var(--muted))] rounded-lg disabled:opacity-50 transition-colors"
                title="Refresh data"
              >
              ...
              <button
                ...
                className="p-2 text-muted-foreground hover:text-[hsl(var(--primary))] hover:bg-[hsl(var(--muted))] rounded-lg transition-colors"
                title="Export data"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <Card className="border border-[hsl(var(--border))] bg-[hsl(var(--card))]">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-muted-foreground font-medium">Total Audits</p>
                  <p className="text-2xl font-semibold text-[hsl(var(--foreground))]">{totalResponses}</p>
                </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-semibold text-[hsl(var(--foreground))]">{healthScore}</p>
                </div>
                <div className="p-2 bg-[#1B4332]/10 rounded-lg">
              ...
              <div className="mt-4">
                <div className="flex items-center justify-between text-xs mb-1 text-muted-foreground">
                  <span>Progress</span>
                  <span className="font-medium text-[hsl(var(--foreground))]">{healthScore}/100</span>
                </div>
          ...
          <Card className="border border-[hsl(var(--border))] bg-[hsl(var(--card))]">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-muted-foreground font-medium">High Risk Items</p>
                  <p className="text-2xl font-semibold text-[hsl(var(--foreground))]">
                    {getRiskPercentage('High Risk')}%
                  </p>
                </div>
              ...
              <div className="mt-4">
                <span
                  className={`text-xs px-2 py-1 rounded-full border ${
                    getRiskPercentage('High Risk') > 0
                      ? 'text-red-700 bg-red-50 border-red-200 dark:bg-red-900/20 dark:text-red-400 dark:border-red-600'
                      : 'text-green-700 bg-green-50 border-green-200 dark:bg-green-900/20 dark:text-green-400 dark:border-green-600'
                  }`}
                >
                  {getRiskPercentage('High Risk') > 0
                    ? 'Requires Attention'
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-semibold text-[hsl(var(--foreground))]">{completionRate}%</p>
                </div>
                <div className="p-2 bg-[#1B4332]/10 rounded-lg">
                  ...
                  {healthScore > 0 ? (
                    <>
                      ...
                      <div className="space-y-4">
                        <p className="text-muted-foreground text-sm">{healthSummary}</p>
                        <Link to="/health">
                          <Button className="w-full bg-[#1B4332] hover:bg-[#2D5A4B] text-white">
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-muted-foreground mb-4">
                        Complete a financial health analysis to get your score
                      </p>
                      <Link to="/health">
                  ...
                  <div className="space-y-3">
                    {QUICK_ACTIONS.map((action) => (
                      <Link key={action.link} to={action.link}>
                        <div className="flex items-center p-3 border border-[hsl(var(--border))] rounded-lg hover:bg-[hsl(var(--muted))] transition-colors">
                          <div className={`${action.color} p-2 rounded-lg mr-3`}>
                            <action.icon className="w-4 h-4 text-white" />
                          </div>
                          <div className="flex-1">
                            <div className="font-medium text-[hsl(var(--foreground))]">{action.title}</div>
              ...
              <Card className="border border-[hsl(var(--border))] bg-[hsl(var(--card))]">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="bg-[hsl(var(--muted))] text-[hsl(var(--foreground))] border border-[hsl(var(--border))]">
                  ...
                  <div className="h-[280px]">
                    {totalResponses > 0 && chartData.length > 0 ? (
                        ...
                        <div className="w-1/3 pl-4 flex flex-col justify-center space-y-3">
                          {chartData.map((item) => (
                            <div key={item.name} className="flex items-center">
                              ...
                              />
                              <div className="flex-1 text-xs text-[hsl(var(--foreground))] flex justify-between">
                      ...
                      <div className="h-full flex items-center justify-center text-center">
                        ...
                        <h3 className="text-lg font-semibold text-[hsl(var(--foreground))] mb-2">No Risk Data</h3>
                        <p className="text-muted-foreground">Complete audits to see risk distribution</p>
                      </div>
                    )}
                  </div>
                </CardContent>
                  ...
                  <div className="h-[280px]">
                    {feeRevenueData.length > 0 ? (
                      ...
                      <div className="h-full flex items-center justify-center text-center">
                        ...
                        <h3 className="text-lg font-semibold text-[hsl(var(--foreground))] mb-2">No Financial Data</h3>
                        <p className="text-muted-foreground">Complete audits to see performance analysis</p>
                      </div>
                    )}
                  </div>
                </CardContent>
                ...
                {filteredAudits.length > 0 ? (
                  <div className="space-y-3">
                    {filteredAudits.map((audit) => (
                      <div
                        key={audit.id}
                        className="flex items-center justify-between p-3 border border-[hsl(var(--border))] rounded-lg hover:bg-[hsl(var(--muted))] transition-colors"
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-medium text-[hsl(var(--foreground))]">{audit.name}</h4>
                            <p className="text-xs text-muted-foreground">{audit.date}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <div className="text-right">
                            <div className="text-sm font-semibold text-[hsl(var(--foreground))]">{audit.score}</div>
                    ...
                    {totalResponses > 3 && (
                      <div className="text-center pt-4">
                        <Link to="/intake">
                          <Button className="border border-[hsl(var(--border))] bg-[hsl(var(--background))] text-[hsl(var(--foreground))] hover:bg-[hsl(var(--muted))]">
                            View All Audits
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-3 bg-[hsl(var(--muted))] rounded-lg border border-[hsl(var(--border))]">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-sm font-medium text-[hsl(var(--foreground))]">Performance</p>
                      <p className="text-xs text-muted-foreground mt-1">System operating at optimal levels</p>
                    </div>
                  </div>
                </div>
                <div className="p-3 bg-[hsl(var(--muted))] rounded-lg border border-[hsl(var(--border))]">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-sm font-medium text-[hsl(var(--foreground))]">Security</p>
                      <p className="text-xs text-muted-foreground mt-1">All systems secured and encrypted</p>
                    </div>
                  </div>
                </div>
                <div className="p-3 bg-[hsl(var(--muted))] rounded-lg border border-[hsl(var(--border))]">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-sm font-medium text-[hsl(var(--foreground))]">Data</p>
                      <p className="text-xs text-muted-foreground mt-1">Real-time financial data processing</p>
                    </div>
                  </div>
                </div>
              </div>
