  ...
  return (
    ...
    >
      <style>{`
        ...
        .btn-secondary:hover { background: #52796F !important; border-color: #52796F !important; color: #F8F5F0 !important; }
          ...
          <CardContent>
            <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-12 gap-4">
              ...
              <div className="md:col-span-2 flex items-end">
                <Button type="submit" className="w-full btn-primary" disabled={isSearching}>
