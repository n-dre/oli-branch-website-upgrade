      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12 space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Oli-Branch LLC ("Company," "we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access our services.
              </p>
            </div>

            {/* Information We Collect */}
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ color: colors.forest }}>2. Information We Collect</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
                We may collect information about you in a variety of ways:
              </p>
              
              <h3 className="text-lg font-semibold mb-2" style={{ color: colors.sage }}>Personal Data</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
                When you register for an account, we collect personally identifiable information, such as:
              </p>
              ...
              <h3 className="text-lg font-semibold mb-2" style={{ color: colors.sage }}>Usage Data</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ color: colors.forest }}>3. How We Use Your Information</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            {/* Data Sharing */}
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ color: colors.forest }}>4. Disclosure of Your Information</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
              ...
              <p className="text-gray-600 leading-relaxed mt-4 p-4 rounded-lg" style={{ backgroundColor: `${colors.sage}10` }}>
                <strong>Important:</strong> We do NOT sell your personal information to third parties. We do NOT receive kickbacks or referral fees from banks based on your data.
              </p>
            </div>

            {/* Data Security */}
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ color: colors.forest }}>5. Data Security</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            {/* Data Retention */}
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ color: colors.forest }}>6. Data Retention</h2>
              <p className="text-gray-600 leading-relaxed">
            ...
            {/* Your Rights */}
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ color: colors.forest }}>7. Your Privacy Rights</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
              ...
              <p className="text-gray-600 leading-relaxed mt-4">
                To exercise any of these rights, please contact us at contact@oli-branch.com.
              </p>
            </div>

            {/* Cookies */}
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ color: colors.forest }}>8. Cookies and Tracking Technologies</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
            ...
            {/* Third-Party Links */}
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ color: colors.forest }}>9. Third-Party Links</h2>
              <p className="text-gray-600 leading-relaxed">
            ...
            {/* Children's Privacy */}
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ color: colors.forest }}>10. Children's Privacy</h2>
              <p className="text-gray-600 leading-relaxed">
                Our services are not intended for individuals under the age of 18. We do not knowingly collect personally identifiable information from children under 18. If you are a parent or guardian and you are aware that your child has provided us with personal data, please contact us.
              </p>
            </div>

            {/* Changes to Policy */}
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ color: colors.forest }}>11. Changes to This Privacy Policy</h2>
              <p className="text-gray-600 leading-relaxed">
          ...
          <div className="mt-8 text-center">
            <Link to="/signup" className="inline-flex items-center gap-2 font-medium transition-colors" style={{ color: colors.forest }}>
